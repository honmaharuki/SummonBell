...
import 'package:summon_bell/database_ex/too_do_items_dao.dart'; // Driftの主要な機能を含むdriftパッケージをインポート
...
class AppDatabasEx extends _$AppDatabasEx {
  // アプリのデータベースクラス
  AppDatabasEx() : super(_openConnection()); // コンストラクタでデータベース接続を開始
